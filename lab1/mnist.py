...
class Model(nn.Module):
    ...
    def __init__(self, lengths: list) -> None:
        ...
        self.fc1 = nn.Linear(lengths[0], lengths[1])
        self.bn1 = nn.BatchNorm1d(lengths[1])
        self.relu = F.ReLU()
        self.fc2 = nn.Linear(lengths[1], lengths[2])
...
def main():
    ...
    criterion = F.SoftmaxLoss(n_classes=n_classes)
