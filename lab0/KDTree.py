...
if __name__ == '__main__':
    ...
    train_data_ori, train_label, test_data_ori, test_label = load_mnist()
    ...
    kd_tree = KDTree( train_data_pca, train_label)
    end1 = time.time()
    ...
    print("程序运行时间：", search_all_time/len(test_data_pca))
    print("平均计算次数：", calu_dist_nums / len(test_data_pca))
